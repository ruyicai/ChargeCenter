...
/**
 * 功能：支付类验证URL类 公司名称：alipay 修改时间：2008-10-10
 * */
public class CheckURL {
	private static final Logger logger = Logger.getLogger(CheckURL.class);
	...
	public static String check(String urlvalue) {
		...
		try {
			...
			logger.error("支付宝语音充值验证请求出现异常  Exception1:" + e.toString()
