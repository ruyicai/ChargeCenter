...
public enum ErrorCode {
	...
	Ttransaction_TypeNotBankCharge("310001", "交易类型为非银行卡充值"),
	
	Ttransaction_IdEmpty("310002", "TtransactionId为空"),
	...
	Charge_JsonStringError("800000", "JSON串参数有误"),
	CardCharge_AlreadySuccess("800001", "如意彩卡充值已经成功"),
	Charge_GenCardPwdError("800002", "生成卡密码有误"),
	Charge_DateFormatError("800003", "时间格式化出错"),
	Charge_SellAmtError("800004", "卡销售数量出错"),
	Charge_CreateFileError("800005", "创建文件出错"),
	Charge_WriteFileError("800006", "写文件出错"),
	Charge_BuildKeyError("800007", "创建公/私钥出错"),
	Charge_SignError("800008", "订单签名出错"),
	Charge_VerifyTransResponseError("800009", "验证交易应答出错"),
	Charge_JsonStringChargeTypeError("800010", "JSON串chargetype参数有误"),
	Charge_TcardChannelNullError("800011", "该卡channel为空"),
	Charge_OrderSubmitFail("800012", "订单提交失败"),
