package com.ruyicai.charge.yeepay.htmlcommon;
...
public class PaymentForOnlineService {
	private static Logger logger = Logger.getLogger(PaymentForOnlineService.class);
	private static String p1_MerId = ConfigUtil.getConfig("charge.properties", "yeepay.merid"); // 商家ID
	private static String queryRefundReqURL = ConfigUtil.getConfig("charge.properties", "yeepay.htmlcommon.queryrefundrequrl"); // 请求地址
	private static String keyValue = ConfigUtil.getConfig("charge.properties", "yeepay.keyvalue"); // 商家密钥
