...
import com.ruyicai.charge.util.HttpUtils;
import com.ruyicai.charge.util.QueryResult;
import com.ruyicai.charge.util.RefundResult;
...
public class PaymentForOnlineService {
	...
	private static String p1_MerId 			= ConfigUtil.getConfig("charge.properties", "p1_MerId");// 商家ID
	private static String queryRefundReqURL = ConfigUtil.getConfig("charge.properties", "queryRefundReqURL");// 请求地址
	private static String keyValue 			= ConfigUtil.getConfig("charge.properties", "keyValue");// 商家密钥
